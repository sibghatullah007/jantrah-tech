        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-md-4 pt-5">
                    <h2 className="h2 text-success border-bottom pb-3 border-light logo">Jantrah Tech</h2>
                    <ul className="list-unstyled text-light footer-link-list">
                        <li>
                            <i className="fas fa-map-marker-alt fa-fw"></i>
                            F-118 Hamdan Heights Ghauri Town, Islamabad
                        </li>
                        <li>
                ...
                <div className="row pt-2">
                    <div className="col-12">
                        <p className="text-left text-light">
                            ...
                            | Designed by <a rel="sponsored" href="https://fb.com" target="_blank">TemplateMo</a>
                        </p>
                    </div>
                </div>
            </div>
